...
import './transactions/pf-transactions.js';
import './expenses/pf-expenses.js';
import './income/pf-income.js';
/**
 * @customElement
 * @polymer
 */
class PfApp extends Aydin.ReduxMixin(Aydin.FirebaseMixin(Element)) {
  static get template() {
    return `
    <style>
